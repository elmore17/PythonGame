...
def findKeyword(n1, dataElements, problem):
    dataPointer = 0
    saveKeywordNumber = -1
    textLocation = ''
    foundKeyword = ''
...
def conjugateString(text, keyword, location, dataElements, problem):
    dataPointer = 36
...
async def eliza_chat(n1, n2, n3, dataElements):
        ...
        if str(regExMagic(pattern, problem)) == "None":
            if problem == previousProblem:
                ...
                if saveKeywordNumber > -1:
                    ...
                    conjugatedString = conjugateString(problem, foundKeyword, locationInText, dataElements, problem)
                else:
                    keywordNumber = 35
                dataPointer = n1 + n2
...
n2 = 12
n3 = 112
run(eliza_chat(n1, n2, n3, dataElements))
